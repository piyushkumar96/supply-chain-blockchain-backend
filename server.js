...
const   config = require('./config/config.json'),      // contains golbal configuration varibales
        ...
        orderRoutes = require('./api/routes/orders/ordersRoute'),
        iotDevicesRoutes = require('./api/routes/iotdevices/iotDevicesRoute');
        
require('./fabric-config.js');
